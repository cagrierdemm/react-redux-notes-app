  ...
  return (
    <form onChange={handleChange}>
      <div className='mt-5 col-lg-5 col-md-7 col-sm-9 col-xs-12 mx-auto search'>
        <button className='col-2 fw-light' type="search" onClick={(e) => e.preventDefault()}>Search</button>
        <input className='col-10 fw-light' type='search' placeholder='Search' value={value} onChange={(e) => setValue(e.target.value)} />
      </div>
    </form>
  )
}
